...
export default async function NewsPage() {
  ...
  return <>
    <OriginalBanner breadcrumb="Berita" label="Informasi Terkini" title="Berita & Kegiatan" description="Ikuti kabar terbaru seputar prestasi, kegiatan, dan perkembangan SMAS Putra Persada Batam." />
